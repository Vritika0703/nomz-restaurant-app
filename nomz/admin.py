...
class SystemPerformanceMetricAdmin(admin.ModelAdmin):
    list_display = ("created_at", "method", "path", "status_code", "duration_ms", "is_error")
...
class SystemPerformanceSnapshotAdmin(admin.ModelAdmin):
    list_display = ("interval_end", "interval_start", "total_requests", "error_requests", "error_rate", "avg_latency_ms", "max_latency_ms")
...
class SystemAlertAdmin(admin.ModelAdmin):
    list_display = ("created_at", "alert_type", "severity", "is_active", "resolved_at", "message")
...
class SystemAuditLogAdmin(admin.ModelAdmin):
    list_display = ("created_at", "level", "action", "actor_username", "request_path", "http_method")
    list_filter = ("level", "action")
    search_fields = ("actor_username", "action", "request_path", "ip_address", "user_agent")
    ordering = ("-created_at",)
