...
class UserProfile(models.Model):
    ...
    is_approved = models.BooleanField(default=True, help_text="Designates whether this business account has been approved by an administrator.")
    is_rejected = models.BooleanField(default=False, help_text="Designates whether this business account has been rejected by an administrator.")
