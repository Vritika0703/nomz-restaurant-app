...
def signin(request):
    ...
    return render(request, 'nomz/auth/signin.html', {
...
def dashboard(request):
    ...
    return render(request, 'nomz/diner/dashboard.html', {
...
def search_results(request):
    ...
    return render(request, 'nomz/diner/search_results.html', {
        'initial_query': query,
        'initial_neighborhood': neighborhood
    })
...
def restaurant_detail(request, restaurant_id):
    ...
    return render(request, 'nomz/diner/restaurant_detail.html', {
...
def add_review(request, restaurant_id):
    """Add review form"""
    return render(request, 'nomz/diner/add_review.html', {
        'restaurant_id': restaurant_id
    })
...
def message_thread(request, conversation_id):
    ...
    return render(request, 'nomz/diner/message_thread.html', {
...
def report_content(request, content_type, content_id):
    ...
    return render(request, 'nomz/diner/report_content.html', {
...
def claim_restaurant(request):
    ...
    return render(request, 'nomz/restaurant/claim.html', {'has_restaurant': has_restaurant})
...
def approved_accounts(request):
    ...
    return render(request, 'nomz/admin/accounts.html', {
        'status': 'approved'
    })
