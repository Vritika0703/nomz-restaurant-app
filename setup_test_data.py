...
from nomz.models import FriendConversation, UserProfile

u1, _ = User.objects.get_or_create(username='admin', defaults={'email': 'admin@example.com'})
u1.set_password('admin_password')
u1.is_staff = True
u1.is_superuser = True
u1.save()

u2, _ = User.objects.get_or_create(username='friend', defaults={'email': 'friend@example.com'})
...
conv, created = FriendConversation.objects.get_or_create(user1=u1, user2=u2, is_group=False)
if created:
